...
You'll see the error straight away so `R CMD check` isn't so important

**Your turn**: Make this function work by adding the necessary imports.
...
For functions that you only use in few functions I think this is easier for the human (although it's slightly more work for the computer)
...
Looking at the NAMESPACE file can be a useful way to get a glimpse of the whole package.

## DESCRIPTION

The stats package is special because it's a base package that's always available. That makes life easier. What happens if we import from another CRAN package? 
...
**Your turn**: How can you measure the costs? Look at the CRAN pages for glue vs. dplyr. What can you learn? 
