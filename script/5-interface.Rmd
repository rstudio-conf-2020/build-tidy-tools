...
* `str_locate()` and zero length match - end is one less that start (think about length)
* length of output for `str_locate_all(NA, "x")` should be zero - invariant is that `NA` matches nothing - 
  not possible to convey enough information for otherwise.
